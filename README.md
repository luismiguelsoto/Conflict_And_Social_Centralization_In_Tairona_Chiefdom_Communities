...
Manuscript Summary:
----------------------------------
This article discusses the social and political organization of the Tairona period in the Río Frío basin, proposing that settlements were structured around two supralocal centers accompanied by multiple local communities, all with varying degrees of centralization and political integration. The absence of a central place suggests a low level of hierarchization, with various types of communities indicating independent forms of decision-making and some degree of economic autonomy. The study is based on contemporary theoretical frameworks of archaeological theory, drawing on new data on these chiefdom communities of northern Colombia, a little explored region but of notable archaeological relevance as a case study for anthropological research on the pre-Hispanic social complexity of northern South America. It is concluded that the coexistence of multiple forms of social organization and the absence of a single dominant sociopolitical center reflect strategies of social organization with little sociopolitical hierarchy, in which the local and supralocal scales are articulated in a complementary way, without leading to the formation of highly centralized political entities as suggested by the chronicles of the Spanish conquistadors of the 16th century AD, or the first archaeological investigations of the region that argued for the presence of state societies.
